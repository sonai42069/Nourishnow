                            ...
                            if(in_array($img_ext, $extensions) === true){
                                ...
                                if(in_array($img_type, $types) === true){
                                    ...
                                    if(move_uploaded_file($tmp_name,"images/".$new_img_name)){
                                        ...
                                        $insert_query = mysqli_query($con, "INSERT INTO users (id, fname, lname, mobile, email, password, image, status, added_on)
                                        VALUES ({$ran_id}, '{$fname}','{$lname}','{$number}', '{$email}', '{$encrypt_pass}', '{$new_img_name}', 'inactive','$date')");
                                        if($insert_query){
